...
function getNames() {
    var names = document.querySelectorAll('filename');
    return Array.prototype.map.call(names, function(e) {
        return e.textContent;
    });
}
// read sitemap-products.xml file =====================================
casper.start('xml_files/sitemap-products-names.xml',function(){
	fileXmlNames = this.evaluate(getNames); 
});
casper.then(function(){
	casper.each(fileXmlNames,function(ii,fileXmlUrls){
		casper.thenOpen(fileXmlUrls, function() {
